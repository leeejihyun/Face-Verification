...
if __name__ == "__main__":
	...
	# fglfw_result 내 모든 파일 및 디렉토리 삭제
	...
	print("최대 Accuracy: %.3f (threshold: %.2f)" % (max_acc, max_acc_thr))

	# fglfw_result 내 최대 Accuracy에서의 threshold 폴더 생성
	...
	with open('fglfw_result/result.txt', 'w') as f:
		...
		f.write("최대 Accuracy: %.3f (threshold: %.2f)\n" % (max_acc, max_acc_thr))
		f.write('\n')
		f.write("<속도>\n")
